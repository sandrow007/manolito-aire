...
const translations = {
	es: {
		...
		treesBtn: "Árboles",
		osmRefreshBtn: "↻ Actualizar mapa",
		osmRefreshTitle: "Baja los datos nuevos de OpenStreetMap (árboles y puntos) para esta zona",
		osmRefreshing: "Actualizando…",
		osmRefreshed: "Datos de OpenStreetMap actualizados en esta zona.",
	...
	ca: {
		...
		treesBtn: "Arbres",
		osmRefreshBtn: "↻ Actualitza el mapa",
		osmRefreshTitle: "Baixa les dades noves d'OpenStreetMap (arbres i punts) per a aquesta zona",
		osmRefreshing: "Actualitzant…",
		osmRefreshed: "Dades d'OpenStreetMap actualitzades en aquesta zona.",
	...
	eu: {
		...
		treesBtn: "Zuhaitzak",
		osmRefreshBtn: "↻ Eguneratu mapa",
		osmRefreshTitle: "Deskargatu OpenStreetMap-en datu berriak (zuhaitzak eta puntuak) eremu honetarako",
		osmRefreshing: "Eguneratzen…",
		osmRefreshed: "OpenStreetMap-en datuak eguneratu dira eremu honetan.",
	...
	gl: {
		...
		treesBtn: "Árbores",
		osmRefreshBtn: "↻ Actualizar o mapa",
		osmRefreshTitle: "Baixa os datos novos de OpenStreetMap (árbores e puntos) para esta zona",
		osmRefreshing: "Actualizando…",
		osmRefreshed: "Datos de OpenStreetMap actualizados nesta zona.",
	...
	en: {
		...
		treesBtn: "Trees",
		osmRefreshBtn: "↻ Refresh map",
		osmRefreshTitle: "Download the latest OpenStreetMap data (trees and points) for this area",
		osmRefreshing: "Refreshing…",
		osmRefreshed: "OpenStreetMap data refreshed for this area.",
	...
	ka: {
		...
		treesBtn: "ხეები",
		osmRefreshBtn: "↻ განაახლე რუკა",
		osmRefreshTitle: "ჩამოტვირთე OpenStreetMap-ის ახალი მონაცემები (ხეები და წერტილები) ამ ზონისთვის",
		osmRefreshing: "ახლდება…",
		osmRefreshed: "OpenStreetMap-ის მონაცემები განახლდა ამ ზონაში.",
