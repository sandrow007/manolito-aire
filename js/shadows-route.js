/* ============================================================
   ...
   volumen de barrido real, halo de "feather", aviso de hora
   dorada/azul, caché de edificios y navegación por teclado.
...
(function () {
  ...
  function inyectarEstilosPanel() {
    ...
    estilo.textContent = `
      ...
      #rsSunNote{ font-size:11px; color:#c98a4b; margin-top:4px; }
