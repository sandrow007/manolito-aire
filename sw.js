...
// Subir VERSION hace que, al activarse, este SW borre las cachés
// viejas (teselas incluidas) y los clientes reciban el JS/CSS nuevo.
//
// Notas de versiones anteriores que conviene recordar:
// - Las teselas de OpenFreeMap usan STALE-WHILE-REVALIDATE. Con
//   cache-first el estilo cacheado apuntaba siempre al planeta
//   viejo (planet/AAAAMMDD.../) y los edificios nuevos de OSM no
//   aparecían. Ahora la tesela se sirve al instante desde caché
//   pero se revalida en segundo plano: el mapa se auto-actualiza.
// - La irradiación solar se consulta por celda real de la malla
//   NASA (0.5°), cacheada por celda (memoria + 7 días), no con
//   coordenadas fijas.
// - Los contadores de agua comparten el mismo arranque
//   (sessionStorage, clave manolito_agua_inicio).
const VERSION = '2026-09-17-c';
...
// Sirve la copia cacheada al instante (si existe) y pide a red en
// segundo plano para refrescarla: velocidad de cache-first sin
...
self.addEventListener('fetch', function(ev) {
	...
	// Teselas del mapa: al instante desde caché + revalidación en
	// segundo plano.
