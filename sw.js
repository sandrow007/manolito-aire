...
// tiene la ruta nueva).
const VERSION = '2026-09-25-f' // -f 26-sep: el sticker "sombra" del desplegable de salud es ahora el que paso Sandro (copa de arbol clara con sombra proyectada en tres capas), alineado con los otros cinco
