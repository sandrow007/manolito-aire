...
! function() {
		...
		a = {
			es: {
				...
				pasos: [{
					...
					title: "La gráfica del aire, al dedillo",
					desc: "Pasa el dedo (o el ratón) por las líneas del aire y verás la hora y el valor exacto de PM2.5. Línea continua: lo medido; discontinua: lo que viene."
				}, {
					...
					title: "El planetario: el sol y la Luna en vivo",
					desc: "Debajo del mapa tienes un mini planetario: la Tierra gira, el sol sube y baja, y ves su altura y su rumbo a cada hora. Mueve la hora del día y mira cómo cambian las sombras."
				}, {
					title: "Renderizado LiDAR",
					desc: "Bajo el planetario hay un botón que abre el visor de nubes de puntos LiDAR: modelos 3D de verdad, punto a punto, para técnicos y curiosos."
				}, {
					...
					desc: "Abajo del todo, en «Sincronizar / Exportar datos», guardas tus ajustes y puntos en un archivo y los recuperas en otro dispositivo. Sin cuentas y sin servidores."
				}, {
			...
			ca: {
				...
				pasos: [{
					...
					title: "La gràfica de l'aire, al dit",
					desc: "Passa el dit (o el ratolí) per les línies de l'aire i veuràs l'hora i el valor exacte de PM2.5. Línia contínua: el mesurat; discontínua: el que ve."
				}, {
					...
					title: "El planetari: el sol i la Lluna en viu",
					desc: "Sota el mapa tens un mini planetari: la Terra gira, el sol puja i baixa, i en veus l'altura i el rumb a cada hora. Mou l'hora del dia i mira com canvien les ombres."
				}, {
					title: "Renderitzat LiDAR",
					desc: "Sota el planetari hi ha un botó que obre el visor de núvols de punts LiDAR: models 3D de veritat, punt a punt, per a tècnics i curiosos."
				}, {
					...
					title: "Emporta't les teves dades",
					desc: "A baix de tot, a «Sincronitzar / Exportar dades», deses els ajustos i els punts en un fitxer i els recuperes en un altre dispositiu. Sense comptes ni servidors."
				}, {
			...
			eu: {
				...
				pasos: [{
					...
					title: "Airearen grafikoa, hatzamarrarekin",
					desc: "Pasatu hatza (edo sagua) airearen lerroetatik eta ordua eta PM2.5 balio zehatza ikusiko dituzu. Lerro jarraia: neurria; etenda: datorrena."
				}, {
					...
					title: "Planetarioa: eguzkia eta Ilargia zuzenean",
					desc: "Maparen azpian mini planetario bat duzu: Lurra biratzen da, eguzkia igotzen eta jaisten da, eta bere altuera eta noranzkoa ordu oro ikusiko dituzu. Mugitu eguneko ordua eta begiratu nola aldatzen diren itzalak."
				}, {
					title: "LiDAR errendatzea",
					desc: "Planetarioaren azpian botoi bat dago, LiDAR puntu-hodeien bisorea irekitzen duena: benetako 3D ereduak, puntuz puntu, teknikarientzat eta jakin-minezkoentzat."
				}, {
					...
					title: "Eraman zure datuak",
					desc: "Beherago, «Sinkronizatu / Esportatu datuak» atalean, ezarpenak eta puntuak fitxategi batean gordetzen dituzu eta beste gailu batean berreskuratzen. Konturik eta zerbitzaririk gabe."
				}, {
					title: "Babestu kausa",
			...
			gl: {
				...
				pasos: [{
					...
					title: "A gráfica do aire, ao dedillo",
					desc: "Pasa o dedo (ou o rato) polas liñas do aire e verás a hora e o valor exacto de PM2.5. Liña continua: o medido; descontinua: o que ven."
				}, {
					...
					title: "O planetario: o sol e a Lúa en vivo",
					desc: "Debaixo do mapa tes un mini planetario: a Terra xira, o sol sobe e baixa, e ves a súa altura e o seu rumbo a cada hora. Move a hora do día e mira como cambian as sombras."
				}, {
					title: "Renderizado LiDAR",
					desc: "Debaixo do planetario hai un botón que abre o visor de nubes de puntos LiDAR: modelos 3D de verdade, punto a punto, para técnicos e curiosos."
				}, {
					title: "Capas do mapa",
					...
					title: "Leva os teus datos",
					desc: "Ao final de todo, en «Sincronizar / Exportar datos», gardas os axustes e puntos nun arquivo e recupéraos noutro dispositivo. Sen contas nin servidores."
				}, {
					title: "Apoia a causa",
			...
			en: {
				...
				pasos: [{
					...
					title: "The air chart, up close",
					desc: "Run your finger (or mouse) along the air lines to see the exact time and PM2.5 value. Solid line: measured; dashed: what is coming."
				}, {
					...
					title: "The planetarium: live sun and Moon",
					desc: "Below the map there is a mini planetarium: the Earth spins, the sun rises and sets, and you can see its height and bearing at any hour. Move the time of day and watch the shadows change."
				}, {
					title: "LiDAR rendering",
					desc: "Under the planetarium there is a button that opens the LiDAR point-cloud viewer: real 3D models, point by point, for technicians and the curious."
				}, {
					title: "Map layers",
					...
					desc: "At the very bottom, under 'Sync / Export data', you save your settings and map points to a file and restore them on another device. No accounts, no servers."
				}, {
			...
			ka: {
				...
				pasos: [{
					...
					title: "ჰაერის გრაფიკა ახლოდან",
					desc: "გადაატარე თითი (ან მაუსი) ჰაერის ხაზებს და ნახავ ზუსტ დროსა და PM2.5 მნიშვნელობას. უწყვეტი ხაზი: გაზომილი; წყვეტილი: რაც მოდის."
				}, {
					...
					title: "პლანეტარიუმი: მზე და მთვარე პირდაპირ",
					desc: "რუკის ქვემოთ მინი პლანეტარიუმია: დედამიწა ტრიალებს, მზე იწევს და ეშვება, და ხედავ მის სიმაღლესა და მიმართულებას ყოველ საათზე. შეცვალე დღის დრო და უყურე, როგორ იცვლება ჩრდილები."
				}, {
					title: "LiDAR რენდერი",
					desc: "პლანეტარიუმის ქვემოთ ღილაკია, რომელიც LiDAR წერტილოვანი ღრუბლების საყურებელს ხსნის: ნამდვილი 3D მოდელები, წერტილ-წერტილ, ტექნიკოსებისა და ცნობისმოყვარეებისთვის."
				}, {
					title: "რუკის ფენები",
					...
					title: "წაიღე შენი მონაცემები",
					desc: "ყველაზე ქვემოთ, «სინქრონიზაცია / მონაცემების ექსპორტის» ბმულზე, შეინახავ პარამეტრებსა და წერტილებს ფაილში და სხვა მოწყობილობაზე აღადგენ. ანგარიშებისა და სერვერების გარეშე."
				}, {
	...
	function construirPasos() {
		...
		return [{
			...
			element: ".chat-fab",
			popover: {
				title: e.pasos[11].title,
				description: e.pasos[11].desc,
				side: "left",
				align: "end"
			}
		}, {
			element: "#btnSyncExport",
			popover: {
				title: e.pasos[12].title,
				description: e.pasos[12].desc,
				side: "top",
				align: "center"
			}
		}, {
			...
			popover: {
				title: e.pasos[13].title,
				description: e.pasos[13].desc,
				side: "top",
				align: "center"
			}
		}, {
			...
			popover: {
				title: e.pasos[14].title,
				description: e.pasos[14].desc,
				side: "top",
				align: "center"
			}
		}]
